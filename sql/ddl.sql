CREATE TABLE coupon_user (
    user_key BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '사용자 고유 번호',
...
CREATE TABLE coupon_issue (
    issue_key BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '쿠폰 발행 번호',
    coupon_info_key BIGINT NOT NULL COMMENT '쿠폰 고유 번호',
    user_key BIGINT NOT NULL COMMENT '사용자 고유 번호',
...
CREATE INDEX idx_coupon_issue_userkey_issuekey_desc ON coupon_issue (user_key, issue_key DESC);
CREATE INDEX idx_coupon_issue_userkey_usableend_desc ON coupon_issue (user_key, usable_end DESC);

CREATE TABLE coupon_info (
     coupon_info_key BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '쿠폰 고유 번호',
     user_key BIGINT NOT NULL COMMENT '사용자 고유 번호',
     ...
     modify_user_key BIGINT COMMENT '수정한 사용자 키',
...
ALTER TABLE coupon_issue ADD CONSTRAINT fk_coupon_issue_coupon_info_key FOREIGN KEY (coupon_info_key) REFERENCES coupon_info(coupon_info_key);
ALTER TABLE coupon_issue ADD CONSTRAINT fk_coupon_issue_user_key FOREIGN KEY (user_key) REFERENCES coupon_user(user_key);
ALTER TABLE coupon_info ADD CONSTRAINT fk_coupon_info_user_key FOREIGN KEY (user_key) REFERENCES coupon_user(user_key);
ALTER TABLE coupon_info ADD CONSTRAINT fk_coupon_info_modify_user_key FOREIGN KEY (modify_user_key) REFERENCES coupon_user(user_key);